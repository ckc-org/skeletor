...
const LoginCard = () => {
  ...
  const handle_text_input = (e: React.ChangeEvent<HTMLInputElement>) => setForm({
    ...form,
  ...
  return (
    ...
    >
      <Card>
        <h1 style={{
          color: card_theme.palette.text.primary,
          backgroundColor: card_theme.palette.primary.main,
          marginTop: 0,
          padding: 10
        }}>Login</h1>
        <CardContent>
